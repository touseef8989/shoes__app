...
import 'package:shoes__app/bottom_navigation_bart/bottom_bar.dart';
  ...
  void loginUser() {
    setState(() {
      if (emailC.text == "test@gmail.com" && passwordC.text == "123456") {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => const ShoesBottomNavigationBar()),
        );
      } else {
        isEmailValid = false;
      ...
      child: Column(
        ...
        children: [
          ...
          InkWell(
              ...
              child: Text("Signup", style: ShoesTextstyle.heading)),
